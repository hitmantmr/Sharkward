  ...
  res.send(`
    ...
    <body>
      <div class="card">
        ...
        <p class="subtitle">Aplikacija <strong>Sharke Shop</strong> želi pristup tvom nalogu.</p>
  ...
  res.send(`
    ...
    <body>
      <div class="card">
        ...
        <p class="subtitle">Aplikacija <strong>Sharke Shop</strong> želi pristup tvom Kick nalogu (prijavljen kao <strong>@${mockUsername}</strong>).</p>
